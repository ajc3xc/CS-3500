...
python3 puckparser2.py "$all_lines"
#while loop only reads to 2nd last of lines
#thus, this needs to be called again to read the last line
#python puckparser2.py "$line"
#echo CORRECT